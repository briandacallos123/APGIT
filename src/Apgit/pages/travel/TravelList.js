...
// _mock_
// import { _travelList } from '../../../_mock';
// import { _travelList } from '../../../_mock/customTable/leave';
import { _travelList } from '../../../_mock/customTable/travel';
// components
...
const TABLE_HEAD = [
  ...
  { id: 'Balance', label: 'Employee', align: 'center', width: 1000 },
  { id: 'Department', label: 'Type', align: 'center', width: 1000 },
  { id: 'Shift', label: 'Place', align: 'center', width: 1000 },
...
export default function TravelList() {
  ...
  const [tableData, setTableData] = useState(_travelList);
  ...
  if (filterName) {
    tableData = tableData.filter(
      (item) =>
        ...
        item.place.toLowerCase().indexOf(filterName.toLowerCase()) !== -1 ||
