...
// import { _type } from '../../../_mock/customTable/accounts/_accountList';
import { _transaction } from '../../../_mock/customTable/leave/_transaction';
// import {  } from '../../../_mock';
// import {  } from '../../../_mock';
// components
...
// dito rin
// import { TransactionHeader } from '../../../sections/@dashboard/invoice/list';

// import AccountList from '../../components/LeaveTables/AccountLists';
// import Transaction from '../../components/Accounts/Deposit';
import Transaction from '../../components/Accounts/TransactionHistory';
import TransactionHeader from '../../components/Accounts/TransactionHeader';

// import { roles } from '../../_mock/role';
// ----------------------------------------------------------------------

const SERVICE_OPTIONS = _transaction.reduce(
  (arr, currentItem) => {
    if (!arr.includes(currentItem.type)) {
      arr.push(currentItem.type);
    }
...
export default function Deposit() {
  ...
  const [tableData, setTableData] = useState(_transaction);
  ...
  const getActive = () => {
    const newData = _transaction.filter((item) => item.status === 'Active');
