...
// import { _task } from '../../../_mock/customTable/clients/_task';
import { _task } from '../../../_mock/customTable/Task/_taskList';
// import {  } from '../../../_mock';
// import {  } from '../../../_mock';
// components
...
// import TaskTable from '../../components/Clients';
...
const TABLE_HEAD = [
  ...
  { id: 'Name', label: 'Name', align: 'center', width: 2000 },
  { id: 'Status', label: 'Status', align: 'center', width: 1000 },
  { id: 'Start', label: 'Start Date', align: 'center', width: 1000 },
  { id: 'End', label: 'End Date', align: 'center', width: 1000 },
  { id: 'Assigned', label: 'Assigned To', align: 'center', width: 1000 },
  { id: 'Priority', label: 'Priority', align: 'center', width: 1000 },
...
export default function InvoiceList() {
  ...
  const [tableData, setTableData] = useState(_task);
...
function applySortFilter({
  ...
  if (filterName) {
    tableData = tableData.filter(
      (item) =>
        item.employeeName.toLowerCase().indexOf(filterName.toLowerCase()) !== -1 ||
        item.assign.toLowerCase().indexOf(filterName.toLowerCase()) !== -1 ||
