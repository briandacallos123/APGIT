...
// _mock_
// import { _awardList } from '../../../_mock';
// import { _awardList } from '../../../_mock/customTable/leave';
import { _awardList } from '../../../_mock/customTable/award';
// components
...
const TABLE_HEAD = [
  ...
  { id: 'Balance', label: 'Employee', align: 'center', width: 2000 },
  { id: 'Department', label: 'Award Type', align: 'center', width: 1000 },
  { id: 'Shift', label: 'Gift', align: 'center', width: 1000 },
  { id: 'Amount', label: 'Amount', align: 'center', width: 1000 },
  { id: 'Date', label: 'Date', align: 'center', width: 1000 },
...
export default function AwardList() {
  ...
  const [tableData, setTableData] = useState(_awardList);
  ...
  if (filterName) {
    tableData = tableData.filter(
      (item) =>
        ...
        item.awardType.toLowerCase().indexOf(filterName.toLowerCase()) !== -1 ||
        item.gift.toLowerCase().indexOf(filterName.toLowerCase()) !== -1 ||
