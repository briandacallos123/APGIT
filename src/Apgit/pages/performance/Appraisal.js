...
// _mock_
// import { _appraisal } from '../../../_mock';
// import { _appraisal } from '../../../_mock/customTable/leave';
import { _appraisal } from '../../../_mock/customTable/performance';
// components
...
const TABLE_HEAD = [
  ...
  { id: 'Balance', label: 'Employee', align: 'center', width: 300 },
  { id: 'Department', label: 'Department', align: 'center', width: 1000 },
  { id: 'Shift', label: 'Designation', align: 'center', width: 1000 },
  ...
  { id: 'Action', label: 'Action', align: 'center', width: 1000 },
  { id: '' },
];
...
export default function Appraisal() {
  ...
  const [tableData, setTableData] = useState(_appraisal);
  ...
  if (filterName) {
    tableData = tableData.filter(
      (item) =>
        ...
        item.createdAt.toLowerCase().indexOf(filterName.toLowerCase()) !== -1 ||
