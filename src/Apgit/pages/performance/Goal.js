...
// _mock_
// import { _goal } from '../../../_mock';
// import { _goal } from '../../../_mock/customTable/leave';
import { _goal } from '../../../_mock/customTable/performance';
// components
...
// import GoalTable from '../../components/LeaveTables/LeaveGoalTable';
...
const TABLE_HEAD = [
  ...
  { id: 'Balance', label: 'Suabject', align: 'center', width: 1000 },
  { id: 'Department', label: 'Target Achievement', align: 'center', width: 1000 },
  { id: 'Shift', label: 'Rating', align: 'center', width: 1000 },
  { id: 'Status', label: 'Progress', align: 'center', width: 1000 },
  { id: 'Amount', label: 'Start Date', align: 'center', width: 1000 },
  { id: 'Date', label: 'End Date', align: 'center', width: 1000 },
...
export default function Goal() {
  ...
  const [tableData, setTableData] = useState(_goal);
